...
class RiwayatPressure extends StatefulWidget {
  static const nameRoute = '/pressures';
  const RiwayatPressure(String bh, {super.key});

  @override
  State<RiwayatPressure> createState() => _RiwayatPressureState();
}

class _RiwayatPressureState extends State<RiwayatPressure> {
  ...
  StreamController<List<PressureModel>> streamPress =
      StreamController.broadcast();
  late Timer timer;
  TableperEnergy getLatestpress = TableperEnergy();
  ...
  Future<void> latestpress() async {
    try {
      ...
      if (!streamPress.isClosed) {
        streamPress.addError('Failed to fetch current data');
      }
                ...
                ClipRRect(
                  ...
                  child: Container(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: StreamBuilder<List<PressureModel>>(
                        ...
                        builder: (context, snapshot) {
                          if (snapshot.connectionState ==
                            ...
                            List<PressureModel> curList = snapshot.data!;
                            return DataTable(
                              sortColumnIndex: 0,
                              sortAscending: true,
                              border: TableBorder(
