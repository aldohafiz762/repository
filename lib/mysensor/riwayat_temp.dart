...
class RiwayatTemp extends StatefulWidget {
  static const nameRoute = '/temperatures';
  const RiwayatTemp(String bg, {super.key});

  @override
  State<RiwayatTemp> createState() => _RiwayatTempState();
}

class _RiwayatTempState extends State<RiwayatTemp> {
  ...
  StreamController<List<TempModel>> streamtemp = StreamController.broadcast();
  late Timer timer;
  TableperEnergy getLatesttemp = TableperEnergy();
  ...
  Future<void> latesttemp() async {
    try {
      ...
      if (!streamtemp.isClosed) {
        streamtemp.addError('Failed to fetch current data');
      }
                ...
                ClipRRect(
                  ...
                  child: Container(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: StreamBuilder<List<TempModel>>(
                        ...
                        builder: (context, snapshot) {
                          if (snapshot.connectionState ==
                            ...
                            List<TempModel> curList = snapshot.data!;
                            return DataTable(
                              sortColumnIndex: 0,
                              sortAscending: true,
                              border: TableBorder(
                              ...
                              rows: curList.map((e) {
                                ...
                                return DataRow(cells: [
                                  ...
                                  DataCell(SelectableText("${e.temperature}",
                                      style: TextStyle(
                                          color: Colors.black,
                                          fontSize: blockVertical * 2))),
                                  DataCell(Row(
                                    children: [
                                      ...
                                      CircleAvatar(
                                        ...
                                        backgroundColor: (e.temperature < 80)
                                            ? Colors.green
                                            : Colors.red,
                                      ),
                                    ],
