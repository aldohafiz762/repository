...
class RiwayatStrain extends StatefulWidget {
  static const nameRoute = '/strains';
  const RiwayatStrain(String bi, {super.key});

  @override
  State<RiwayatStrain> createState() => _RiwayatStrainState();
}

class _RiwayatStrainState extends State<RiwayatStrain> {
  ...
  StreamController<List<StrainModel>> streamStrain =
      StreamController.broadcast();
  late Timer timer;
  TableperEnergy getLateststrain = TableperEnergy();
  ...
  Future<void> lateststrain() async {
    try {
      ...
      if (!streamStrain.isClosed) {
        streamStrain.addError('Failed to fetch current data');
      }
                ...
                ClipRRect(
                  ...
                  child: Container(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: StreamBuilder<List<StrainModel>>(
                        ...
                        builder: (context, snapshot) {
                          if (snapshot.connectionState ==
                            ...
                            List<StrainModel> curList = snapshot.data!;
                            return DataTable(
                              sortColumnIndex: 0,
                              sortAscending: true,
                              border: TableBorder(
                              ...
                              rows: curList.map((e) {
                                ...
                                return DataRow(cells: [
                                  ...
                                  DataCell(SelectableText("${e.strain}",
                                      style: TextStyle(
                                          color: Colors.black,
                                          fontSize: blockVertical * 2))),
                                  DataCell(Row(
