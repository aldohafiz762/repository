...
class ListHistoryRepair extends StatefulWidget {
  const ListHistoryRepair(
  ...
  @override
  _ListHistoryRepairState createState() => _ListHistoryRepairState();
}

class _ListHistoryRepairState extends State<ListHistoryRepair>
  ...
  final GetAlarmRepair preventive = GetAlarmRepair();
