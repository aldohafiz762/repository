...
import 'package:project_tugas_akhir_copy/newdata/biglosses_list_data.dart';
...
class MealsView extends StatelessWidget {
  const MealsView(
      {Key? key, this.mealsListData, this.animation, this.animationController})
      : super(key: key);
