...
class ListHistoryStock extends StatefulWidget {
  const ListHistoryStock(
  ...
  @override
  _ListHistoryStockState createState() => _ListHistoryStockState();
}

class _ListHistoryStockState extends State<ListHistoryStock>
  ...
  final GetAlarmStock preventive = GetAlarmStock();
